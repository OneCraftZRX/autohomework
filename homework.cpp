...
int main()
{
	...
	cout<<current<<endl;
	string filePath = "C:\\Users\\Administrator\\Desktop\\homework\\";
	...
	char copy1[300]={"copy C:\\Users\\Administrator\\Desktop\\template.docx C:\\Users\\Administrator\\Desktop\\homework\\"};
	char copy2[300]={0};
	char copyall[300]={0};
	char docname[100]={0};
	string temp1=".docx";
	...
	system(final);
	system(copyall);
	string docname_str = "C:\\Users\\Administrator\\Desktop\\homework\\";
